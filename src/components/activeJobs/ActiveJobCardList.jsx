...
import { deleteJobUrl, getActiveJobsUrl } from "../../apis/apiEndPoints";
...
function ActiveJobCardList() {
  ...
  const fetchAllJobs = useCallback(async () => {
    try {
      dispatch(setLoading(true));
      const { data: res } = await getActiveJobsUrl(paginationModel);
  ...
  async function fetchNextJobs() {
    ...
    try {
      ...
      const { data: res } = await getActiveJobsUrl(newPaginationModel);
      const resData = res.data;
...
export default ActiveJobCardList;
